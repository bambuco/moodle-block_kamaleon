...
/**
 * Strings for component 'block_kamaleon', language 'es'
 *
...
$string['configinstanceparams'] = 'Parámetros de la instancia';
$string['configinstanceparams_help'] = 'Parámetros adicionales que se pasarán al controlador de tipo de contenido.
El formato es parámetro=valor, uno por línea. Por ejemplo, para mostrar el texto de las entradas del blog con 300 caracteres, puede configurar: <br>
<b>contentlength=300</b>.';
$string['configmaxrecords'] = 'Número máximo de registros';
...
$string['errornotcontentdata'] = 'Error: No se encontraron contenidos.';
...
$string['title'] = 'Título';
$string['tool_courserating_show'] = 'Mostrar';
$string['tool_courserating_show_help'] = 'Elija cómo seleccionar las valoraciones.';
$string['tool_courserating_show_recent'] = 'Recientes';
$string['tool_courserating_show_top'] = 'Destacadas';
